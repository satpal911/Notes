      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="flex justify-start gap-4">
          ...
          <button 
            ...
            className='bg-yellow-500 hover:bg-yellow-600 active:scale-95 transition-all p-3 px-8 rounded-[2rem] font-bold text-white cursor-pointer flex items-center gap-2 shadow-lg'
          >
            Change Password 
          </button>
        </div>
